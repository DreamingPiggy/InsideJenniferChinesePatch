# TODO: Translation updated at 2022-05-09 16:11
...
translate chinese strings:
    ...
    new "此菜单上的选项旨在提高可访问性。它们可能不适用于所有的游戏，一些选项的组合可能使游戏不可玩。这不是游戏或引擎的问题。为了在改变字体时得到最好的效果，尽量保持文本的大小与原来一样。"
    ...
    new "这个程序包含许多许可证下的自由软件，包括 MIT 许可证和 GNU宽通用公共许可证。完整的软件列表，包括链接到完整的源代码，可以找到{a=https://www.renpy.org/l/license}这里{/a}."
    ...
    new "启用剪贴板播放功能。按“ shift + c”可以禁用。"

    # renpy/common/00preferences.rpy:601
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自我表达会说\"[renpy.display.tts.last]\". 按’alt + shift + v’关闭。"

    # renpy/common/00preferences.rpy:603
    old "Self-voicing enabled. Press 'v' to disable."
    new "启用自动播放功能。请按“ v”键禁用。"
    ...
    new "图片缓存:[cache_pct:.1f]% ([cache_size_mb:.1f]MB)"
    ...
    new "这个游戏需要使用不能初始化的 GL2。"

    # renpy/common/00gltest.rpy:251
    old "This computer has a problem displaying graphics: [problem]."
    new "这台计算机在显示图形方面有一个问题:[problem]."

    # renpy/common/00gltest.rpy:255
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "它的图形驱动程序可能过时或不能正常运行。这可能导致图形显示缓慢或不正确。"

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "这个{a=edit:1:2.1.1.1.1.1.2.1.2.1.2.2.1.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2}log.txt{/a}文件可能包含帮助您确定您的计算机出了什么问题的信息。"

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "有关如何解决这个问题的更多细节，请参见{a=[url]}文件{/a}."
    ...
    new "将 traceback.txt 文件作为 BBcode 复制到剪贴板，用于 https://lemmasoft.renai.us/论坛等论坛。"
    ...
    new "将 traceback.txt 文件作为 Markdown for Discord 复制到剪贴板。"
    ...
    new "重新加载游戏从磁盘，保存和恢复游戏状态，如果可能的话。"
